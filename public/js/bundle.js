...
var showAlert = exports.showAlert = function showAlert(type, msg) {
  hideAlert();
  var markup = "<div class=\"alert alert-success ".concat(type, "\">").concat(msg, "</div>");
  $('body').prepend(markup);
...
exports.login = exports.addForm = void 0;
...
var addForm = exports.addForm = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 8:
          ...
          (0, _alert.showAlert)('error', "".concat(_context2.t0.response.data.message));
        case 11:
        case "end":
  ...
  return function addForm(_x3, _x4, _x5, _x6) {
...
$(document).on('submit', '#add_form', function (e) {
  ...
  console.log(name, email, password, passwordConfirm);
  (0, _form.addForm)(name, email, password, passwordConfirm);
});
...
$(document).on('submit', '#login_form', function (e) {
  ...
  var password = $(this).find('input[name=password]').val();
  console.log(email, password);
  (0, _form.login)(email, password);
});
},{"./form":"form.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
